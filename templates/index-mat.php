        ...
        -->
          ...
          <div class="mdl-card on-the-road-again mdl-cell mdl-cell--12-col">
            ...
            <? if ($isLoggedIn) { ?>
              ...
              <a id="contacts"><button id="contacts" class="mdl-button mdl-js-button mdl-button--raised"><i class="material-icons">group</i> Contacts</button></a>
              <button href="find/appmedia" class="mdl-button mdl-js-button mdl-button--raised"><i class="material-icons">group</i> Search (ie appmedia)</button>
            <? } else { ?>
